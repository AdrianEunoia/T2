...
public class PestaniaCinco extends JPanel implements ActionListener, ChangeListener, ItemListener {
    ...
    /*private void configurarModeloCombo() {
        modeloCombo.addElement(new Persona("Nombre 1","a",123,23,false));
        modeloCombo.addElement(new Persona("Nombre 2","b",123,23,false));
    }*/
    // Acciones
    ...
    private JPanel configurarCentro() {
        ...
        // Fila 0
        configurarGridBag(0,0,1,1,0,0.2,GridBagConstraints.WEST,GridBagConstraints.NONE,new JLabel("Nombre"));
        configurarGridBag(1,0,1,1,1,0.2,GridBagConstraints.WEST,GridBagConstraints.HORIZONTAL, tNombre);
        ...
        configurarGridBag(0,5,1,1,0,0.2,
                GridBagConstraints.CENTER,GridBagConstraints.NONE,
                bAgregar);

        configurarGridBag(1,5,1,1,0,0.2,
                GridBagConstraints.CENTER,GridBagConstraints.NONE,
                bObtener);
        return pCentro;
    }
    ...
    public void stateChanged(ChangeEvent e) {
        ...
        if (spinnerLista.getModel().getValue().getClass() == Persona.class){
            ...
            System.out.println(pSeleccionada.getTelefono());
        }
